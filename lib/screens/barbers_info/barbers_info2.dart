...
class BarberInfo23456 extends StatefulWidget {
  final BarbersModel userModel;

  const BarberInfo23456({
    super.key,
    required this.userModel,
  });

  @override
  State<BarberInfo23456> createState() => _BarberInfo23456State();
}

class _BarberInfo23456State extends State<BarberInfo23456> {
  @override
